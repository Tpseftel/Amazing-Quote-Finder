          ...
          @csrf
            ...
            <div class="form-row">
                ...
                <label for="start-date" class="text-capitalize font-weight-bold">Start Date: </label>
                    <input type="text" autocomplete="off"  placeholder="yyyy-mm-dd" value="{{old('start_date')}}" id="start-date" name="start_date"
            ...
            <div class="form-row">
                ...
                <label for="end-date" class=" text-capitalize font-weight-bold">End Date: </label>
                    <input type="text" autocomplete="off"  placeholder="yyyy-mm-dd" name="end_date" id="end-date" value="{{old('end_date')}}" 
